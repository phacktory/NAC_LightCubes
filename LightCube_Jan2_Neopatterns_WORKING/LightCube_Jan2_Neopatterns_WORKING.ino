...
Description of build and hardware:
https://www.phacktory.com/blog/......
...
#define NUM_LEDS 192                  // Total number of LEDs on the WS2812b strips inside 
                                      // each Light Cube
int defaultBrightness = 255;          // Default brghtness setting of the LEDs (0 to 255)
int numReads = 1;                     // Audio data averaging. Set to 1 for NO averging
int baseline = 35;                    // Audio noise level 
